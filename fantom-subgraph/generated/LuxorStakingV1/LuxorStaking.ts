...
export class LuxorStaking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LuxorStaking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class LuxorStaking extends ethereum.SmartContract {
  static bind(address: Address): LuxorStaking {
    return new LuxorStaking("LuxorStaking", address);
  }

  Lumens(): Address {
    let result = super.call("Lumens", "Lumens():(address)", []);

    return result[0].toAddress();
  }

  try_Lumens(): ethereum.CallResult<Address> {
    let result = super.tryCall("Lumens", "Lumens():(address)", []);
    if (result.reverted) {
  ...
  Luxor(): Address {
    let result = super.call("Luxor", "Luxor():(address)", []);

    return result[0].toAddress();
  }

  try_Luxor(): ethereum.CallResult<Address> {
    let result = super.tryCall("Luxor", "Luxor():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  epoch(): LuxorStaking__epochResult {
    let result = super.call(
      "epoch",
    ...
    return new LuxorStaking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<LuxorStaking__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint32,uint32)",
      []
  ...
  warmupInfo(param0: Address): LuxorStaking__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new LuxorStaking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<LuxorStaking__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LuxorStaking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
