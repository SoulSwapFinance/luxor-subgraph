...
export class LumensERC20__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LumensERC20 extends ethereum.SmartContract {
  static bind(address: Address): LumensERC20 {
    return new LumensERC20("LumensERC20", address);
  }
  ...
  rebases(param0: BigInt): LumensERC20__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new LumensERC20__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<LumensERC20__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new LumensERC20__rebasesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
